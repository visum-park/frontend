...
const HiringBanner = () => {
  ...
  return (
    <div className="fixed top-15 left-0 w-full z-40 bg-white text-[#2D4B37] overflow-hidden">
      {/* Scrolling text container */}
      <Link
        href="/careers"
        className="flex items-center underline cursor-pointer gap-4 py-2 whitespace-nowrap">
